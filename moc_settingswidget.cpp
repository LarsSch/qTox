...
QT_MOC_LITERAL(1, 15, 17), // "setShowSystemTray"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 8), // "newValue"
QT_MOC_LITERAL(4, 43, 14), // "compactToggled"
QT_MOC_LITERAL(5, 58, 7), // "compact"
QT_MOC_LITERAL(6, 66, 24), // "groupchatPositionToggled"
QT_MOC_LITERAL(7, 91, 17), // "groupchatPosition"
QT_MOC_LITERAL(8, 109, 12) // "onTabChanged"

    },
    "SettingsWidget\0setShowSystemTray\0\0"
    "newValue\0compactToggled\0compact\0"
    "groupchatPositionToggled\0groupchatPosition\0"
    "onTabChanged"
};
...
void SettingsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setShowSystemTray((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->compactToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->groupchatPositionToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsWidget::setShowSystemTray)) {
                *result = 0;
            }
        }
        {
            typedef void (SettingsWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsWidget::compactToggled)) {
                *result = 1;
            }
        }
        {
            typedef void (SettingsWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsWidget::groupchatPositionToggled)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void SettingsWidget::setShowSystemTray(bool _t1)
{
...
// SIGNAL 1
void SettingsWidget::compactToggled(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void SettingsWidget::groupchatPositionToggled(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
