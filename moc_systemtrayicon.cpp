...
#include "src/widget/systemtrayicon.h"
...
void SystemTrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SystemTrayIcon::*_t)(QSystemTrayIcon::ActivationReason );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SystemTrayIcon::activated)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SystemTrayIcon::activated(QSystemTrayIcon::ActivationReason _t1)
{
