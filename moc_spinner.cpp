...
const QMetaObject Spinner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Spinner.data,
      qt_meta_data_Spinner,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Spinner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ChatLineContent"))
        return static_cast< ChatLineContent*>(const_cast< Spinner*>(this));
