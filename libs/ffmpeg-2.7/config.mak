...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=mingw32 --prefix=/Users/lschlimpert/Src/qTox/windows/../libs --enable-memalign-hack --disable-swscale-alpha --disable-programs --disable-doc --disable-postproc --disable-avfilter --disable-avresample --disable-swresample --disable-protocols --disable-filters --disable-network --disable-muxers --disable-sdl --disable-iconv --disable-bzlib --disable-lzma --disable-zlib --disable-xlib --disable-encoders --enable-shared --disable-static --disable-yasm
...
CC_IDENT=Apple LLVM version 7.0.0 (clang-700.0.72)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
EXTRALIBS=-framework QTKit -framework Foundation -framework QuartzCore -framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -Wl,-framework,CoreFoundation -Wl,-framework,Security -framework CoreGraphics -lm -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
