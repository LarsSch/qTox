...
QT_MOC_LITERAL(1, 4, 13), // "processEvents"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "IPC\0processEvents\0"
};
...
const QMetaObject IPC::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_IPC.data,
      qt_meta_data_IPC,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *IPC::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IPC.stringdata0))
        return static_cast<void*>(const_cast< IPC*>(this));
