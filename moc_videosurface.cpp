...
QT_MOC_LITERAL(1, 13, 19), // "onNewFrameAvailable"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 27), // "std::shared_ptr<VideoFrame>"
QT_MOC_LITERAL(4, 62, 8) // "newFrame"

    },
    "VideoSurface\0onNewFrameAvailable\0\0"
    "std::shared_ptr<VideoFrame>\0newFrame"
};
...
void VideoSurface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onNewFrameAvailable((*reinterpret_cast< std::shared_ptr<VideoFrame>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject VideoSurface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VideoSurface.data,
